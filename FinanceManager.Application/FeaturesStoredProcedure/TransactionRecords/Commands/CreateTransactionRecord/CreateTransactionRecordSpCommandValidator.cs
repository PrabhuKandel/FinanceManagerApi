...
{
    public class CreateTransactionRecordSpCommandValidator : AbstractValidator<CreateTransactionRecordSpCommand>
    {
        public CreateTransactionRecordSpCommandValidator(IApplicationDbContext _context)
        {
