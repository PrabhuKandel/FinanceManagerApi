...
{
    public class CreatePaymentMethodDapperCommandValidator : AbstractValidator<CreatePaymentMethodDapperCommand>
    {
        public CreatePaymentMethodDapperCommandValidator(IApplicationDbContext _context)
        {
