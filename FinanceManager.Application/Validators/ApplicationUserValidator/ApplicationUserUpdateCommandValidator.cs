...
{
    public class ApplicationUserUpdateCommandValidator:AbstractValidator<UpdateApplicationUserCommand>
    {
        public ApplicationUserUpdateCommandValidator(IApplicationDbContext context)
        {
