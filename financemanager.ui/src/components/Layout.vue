    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <li><router-link to=""><i class="bi bi-wallet2 me-2"></i>Transactions</router-link></li>
...
<style scoped>
  ...
  .sidebar {
    ...
    /*background-color: #2160a4;*/ /* light gray background */
    color:white;
  ...
  .sidebar-nav li {
    margin-bottom: 1.25rem; /* more spacing between links */
  }
  ...
  .sidebar-nav a {
    ...
    font-size:1.1rem;
    font-weight: 500;
    padding: 0.4rem 0.6rem; /* padding for click area */
    display: block;
    border-radius: 6px;
  ...
  .main-content {
    ...
    display: flex;
    flex-direction: column;
    padding-left: 1rem; /* add some space between sidebar & content */
  }
